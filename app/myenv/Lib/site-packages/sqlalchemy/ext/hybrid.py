...
class _HybridExprCallableType(Protocol[_T_co]):
    def __call__(
        s, cls: Any
    ) -> _HasClauseElement | SQLColumnExpression[_T_co]:
        ...
...
class Comparator(interfaces.PropComparator[_T]):
    ...
    def __init__(
        self, expression: _HasClauseElement | SQLColumnExpression[_T]
    ):
...
class ExprComparator(Comparator[_T]):
    def __init__(
        self,
        cls: type[Any],
        expression: _HasClauseElement | SQLColumnExpression[_T],
