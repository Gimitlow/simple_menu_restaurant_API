...
def create_db(cfg, eng, ident):
    ...
    raise NotImplementedError(
        f'no DB creation routine for cfg: {eng.url}'
    )
...
def drop_db(cfg, eng, ident):
    ...
    raise NotImplementedError(f'no DB drop routine for cfg: {eng.url}')
...
def temp_table_keyword_args(cfg, eng):
    ...
    """
    raise NotImplementedError(
        f'no temp table keyword args routine for cfg: {eng.url}'
    )
