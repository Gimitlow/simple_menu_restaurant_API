...
class ModelField(Representation):
    ...
    def __init__(
        ...
        *,
        ...
        self.sub_fields_mapping: dict[str, 'ModelField'] | None = None  # used for discriminated union
    ...
    def _validate_sequence_like(  # noqa: C901 (ignore complexity)
        ...
        converted: list[Any] | set[Any] | frozenset[Any] | tuple[Any, ...] | Iterator[Any] | Deque[Any] = result
    ...
    def _get_mapping_value(self, original: T, converted: dict[Any, Any]) -> T | dict[Any, Any]:
        """
