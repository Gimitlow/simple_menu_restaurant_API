...
def caching_resolver(*, timeout: int | None = None, cache=None):
    if timeout is None:
...
def validate_email_deliverability(domain: str, domain_i18n: str, timeout: int | None = None, dns_resolver=None):
