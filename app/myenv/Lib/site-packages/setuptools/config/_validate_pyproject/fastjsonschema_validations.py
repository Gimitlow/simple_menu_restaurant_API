                    ...
                    if data__buildsystem__requires_is_list:
                        ...
                        for data__buildsystem__requires_x, data__buildsystem__requires_item in enumerate(data__buildsystem__requires):
                            if not isinstance(data__buildsystem__requires_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.build-system.requires[{data__buildsystem__requires_x}]' + ' must be string', value=data__buildsystem__requires_item, name='' + (
                                    name_prefix or 'data') + f'.build-system.requires[{data__buildsystem__requires_x}]' + '', definition={'type': 'string'}, rule='type')
                    ...
                    if data__buildsystem__backendpath_is_list:
                        ...
                        for data__buildsystem__backendpath_x, data__buildsystem__backendpath_item in enumerate(data__buildsystem__backendpath):
                            if not isinstance(data__buildsystem__backendpath_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.build-system.backend-path[{data__buildsystem__backendpath_x}]' + ' must be string', value=data__buildsystem__backendpath_item, name='' + (
                                    name_prefix or 'data') + f'.build-system.backend-path[{data__buildsystem__backendpath_x}]' + '', definition={'type': 'string', '$comment': 'Should be a path (TODO: enforce it with format?)'}, rule='type')
            ...
            if data__platforms_is_list:
                ...
                for data__platforms_x, data__platforms_item in enumerate(data__platforms):
                    if not isinstance(data__platforms_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.platforms[{data__platforms_x}]' + ' must be string', value=data__platforms_item, name='' + (
                            name_prefix or 'data') + f'.platforms[{data__platforms_x}]' + '', definition={'type': 'string'}, rule='type')
            ...
            if data__provides_is_list:
                ...
                for data__provides_x, data__provides_item in enumerate(data__provides):
                    if not isinstance(data__provides_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.provides[{data__provides_x}]' + ' must be string', value=data__provides_item, name='' + (
                            name_prefix or 'data') + f'.provides[{data__provides_x}]' + '', definition={'type': 'string', 'format': 'pep508-identifier'}, rule='type')
                    if isinstance(data__provides_item, str):
                        if not custom_formats['pep508-identifier'](data__provides_item):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.provides[{data__provides_x}]' + ' must be pep508-identifier', value=data__provides_item, name='' + (
                                name_prefix or 'data') + f'.provides[{data__provides_x}]' + '', definition={'type': 'string', 'format': 'pep508-identifier'}, rule='format')
            ...
            if data__obsoletes_is_list:
                ...
                for data__obsoletes_x, data__obsoletes_item in enumerate(data__obsoletes):
                    if not isinstance(data__obsoletes_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.obsoletes[{data__obsoletes_x}]' + ' must be string', value=data__obsoletes_item, name='' + (
                            name_prefix or 'data') + f'.obsoletes[{data__obsoletes_x}]' + '', definition={'type': 'string', 'format': 'pep508-identifier'}, rule='type')
                    if isinstance(data__obsoletes_item, str):
                        if not custom_formats['pep508-identifier'](data__obsoletes_item):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.obsoletes[{data__obsoletes_x}]' + ' must be pep508-identifier', value=data__obsoletes_item, name='' + (
                                name_prefix or 'data') + f'.obsoletes[{data__obsoletes_x}]' + '', definition={'type': 'string', 'format': 'pep508-identifier'}, rule='format')
            ...
            if data__scriptfiles_is_list:
                ...
                for data__scriptfiles_x, data__scriptfiles_item in enumerate(data__scriptfiles):
                    if not isinstance(data__scriptfiles_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.script-files[{data__scriptfiles_x}]' + ' must be string', value=data__scriptfiles_item, name='' + (
                            name_prefix or 'data') + f'.script-files[{data__scriptfiles_x}]' + '', definition={'type': 'string'}, rule='type')
            ...
            if data__eagerresources_is_list:
                ...
                for data__eagerresources_x, data__eagerresources_item in enumerate(data__eagerresources):
                    if not isinstance(data__eagerresources_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.eager-resources[{data__eagerresources_x}]' + ' must be string', value=data__eagerresources_item, name='' + (
                            name_prefix or 'data') + f'.eager-resources[{data__eagerresources_x}]' + '', definition={'type': 'string'}, rule='type')
                    ...
                    if data__packages_is_list:
                        ...
                        for data__packages_x, data__packages_item in enumerate(data__packages):
                            if not isinstance(data__packages_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.packages[{data__packages_x}]' + ' must be string', value=data__packages_item, name='' + (
                                    name_prefix or 'data') + f'.packages[{data__packages_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='type')
                            if isinstance(data__packages_item, str):
                                if not custom_formats['python-module-name'](data__packages_item):
                                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.packages[{data__packages_x}]' + ' must be python-module-name', value=data__packages_item, name='' + (
                                        name_prefix or 'data') + f'.packages[{data__packages_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='format')
                ...
                for data__packagedir_key, data__packagedir_val in data__packagedir.items():
                    if REGEX_PATTERNS['^.*$'].search(data__packagedir_key):
                        ...
                        if not isinstance(data__packagedir_val, (str)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.package-dir.{data__packagedir_key}' + ' must be string', value=data__packagedir_val, name='' + (
                                name_prefix or 'data') + f'.package-dir.{data__packagedir_key}' + '', definition={'type': 'string'}, rule='type')
                ...
                for data__packagedata_key, data__packagedata_val in data__packagedata.items():
                    if REGEX_PATTERNS['^.*$'].search(data__packagedata_key):
                        ...
                        if not isinstance(data__packagedata_val, (list, tuple)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.package-data.{data__packagedata_key}' + ' must be array', value=data__packagedata_val, name='' + (
                                name_prefix or 'data') + f'.package-data.{data__packagedata_key}' + '', definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
                        ...
                        if data__packagedata_val_is_list:
                            ...
                            for data__packagedata_val_x, data__packagedata_val_item in enumerate(data__packagedata_val):
                                if not isinstance(data__packagedata_val_item, (str)):
                                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.package-data.{data__packagedata_key}[{data__packagedata_val_x}]' + ' must be string', value=data__packagedata_val_item, name='' + (
                                        name_prefix or 'data') + f'.package-data.{data__packagedata_key}[{data__packagedata_val_x}]' + '', definition={'type': 'string'}, rule='type')
                ...
                for data__excludepackagedata_key, data__excludepackagedata_val in data__excludepackagedata.items():
                    if REGEX_PATTERNS['^.*$'].search(data__excludepackagedata_key):
                        ...
                        if not isinstance(data__excludepackagedata_val, (list, tuple)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.exclude-package-data.{data__excludepackagedata_key}' + ' must be array', value=data__excludepackagedata_val, name='' + (
                                name_prefix or 'data') + f'.exclude-package-data.{data__excludepackagedata_key}' + '', definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
                        ...
                        if data__excludepackagedata_val_is_list:
                            ...
                            for data__excludepackagedata_val_x, data__excludepackagedata_val_item in enumerate(data__excludepackagedata_val):
                                if not isinstance(data__excludepackagedata_val_item, (str)):
                                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.exclude-package-data.{data__excludepackagedata_key}[{data__excludepackagedata_val_x}]' + ' must be string', value=data__excludepackagedata_val_item, name='' + (
                                        name_prefix or 'data') + f'.exclude-package-data.{data__excludepackagedata_key}[{data__excludepackagedata_val_x}]' + '', definition={'type': 'string'}, rule='type')
            ...
            if data__namespacepackages_is_list:
                ...
                for data__namespacepackages_x, data__namespacepackages_item in enumerate(data__namespacepackages):
                    if not isinstance(data__namespacepackages_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.namespace-packages[{data__namespacepackages_x}]' + ' must be string', value=data__namespacepackages_item, name='' + (
                            name_prefix or 'data') + f'.namespace-packages[{data__namespacepackages_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='type')
                    if isinstance(data__namespacepackages_item, str):
                        if not custom_formats['python-module-name'](data__namespacepackages_item):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.namespace-packages[{data__namespacepackages_x}]' + ' must be python-module-name', value=data__namespacepackages_item, name='' + (
                                name_prefix or 'data') + f'.namespace-packages[{data__namespacepackages_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='format')
            ...
            if data__pymodules_is_list:
                ...
                for data__pymodules_x, data__pymodules_item in enumerate(data__pymodules):
                    if not isinstance(data__pymodules_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.py-modules[{data__pymodules_x}]' + ' must be string', value=data__pymodules_item, name='' + (
                            name_prefix or 'data') + f'.py-modules[{data__pymodules_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='type')
                    if isinstance(data__pymodules_item, str):
                        if not custom_formats['python-module-name'](data__pymodules_item):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.py-modules[{data__pymodules_x}]' + ' must be python-module-name', value=data__pymodules_item, name='' + (
                                name_prefix or 'data') + f'.py-modules[{data__pymodules_x}]' + '', definition={'type': 'string', 'format': 'python-module-name'}, rule='format')
                ...
                for data__datafiles_key, data__datafiles_val in data__datafiles.items():
                    if REGEX_PATTERNS['^.*$'].search(data__datafiles_key):
                        ...
                        if not isinstance(data__datafiles_val, (list, tuple)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.data-files.{data__datafiles_key}' + ' must be array', value=data__datafiles_val, name='' + (
                                name_prefix or 'data') + f'.data-files.{data__datafiles_key}' + '', definition={'type': 'array', 'items': {'type': 'string'}}, rule='type')
                        ...
                        if data__datafiles_val_is_list:
                            ...
                            for data__datafiles_val_x, data__datafiles_val_item in enumerate(data__datafiles_val):
                                if not isinstance(data__datafiles_val_item, (str)):
                                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.data-files.{data__datafiles_key}[{data__datafiles_val_x}]' + ' must be string', value=data__datafiles_val_item, name='' + (
                                        name_prefix or 'data') + f'.data-files.{data__datafiles_key}[{data__datafiles_val_x}]' + '', definition={'type': 'string'}, rule='type')
                ...
                for data__cmdclass_key, data__cmdclass_val in data__cmdclass.items():
                    if REGEX_PATTERNS['^.*$'].search(data__cmdclass_key):
                        ...
                        if not isinstance(data__cmdclass_val, (str)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.cmdclass.{data__cmdclass_key}' + ' must be string', value=data__cmdclass_val, name='' + (
                                name_prefix or 'data') + f'.cmdclass.{data__cmdclass_key}' + '', definition={'type': 'string', 'format': 'python-qualified-identifier'}, rule='type')
                        if isinstance(data__cmdclass_val, str):
                            if not custom_formats['python-qualified-identifier'](data__cmdclass_val):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.cmdclass.{data__cmdclass_key}' + ' must be python-qualified-identifier', value=data__cmdclass_val, name='' + (
                                    name_prefix or 'data') + f'.cmdclass.{data__cmdclass_key}' + '', definition={'type': 'string', 'format': 'python-qualified-identifier'}, rule='format')
            ...
            if data__licensefiles_is_list:
                ...
                for data__licensefiles_x, data__licensefiles_item in enumerate(data__licensefiles):
                    if not isinstance(data__licensefiles_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.license-files[{data__licensefiles_x}]' + ' must be string', value=data__licensefiles_item, name='' + (
                            name_prefix or 'data') + f'.license-files[{data__licensefiles_x}]' + '', definition={'type': 'string'}, rule='type')
        else:
                    ...
                    if data__file_is_list:
                        ...
                        for data__file_x, data__file_item in enumerate(data__file):
                            if not isinstance(data__file_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.file[{data__file_x}]' + ' must be string', value=data__file_item, name='' + (
                                    name_prefix or 'data') + f'.file[{data__file_x}]' + '', definition={'type': 'string'}, rule='type')
                    data__file_one_of_count7 += 1
                except JsonSchemaValueException:
                    pass
                    ...
                    if data__find__where_is_list:
                        ...
                        for data__find__where_x, data__find__where_item in enumerate(data__find__where):
                            if not isinstance(data__find__where_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.find.where[{data__find__where_x}]' + ' must be string', value=data__find__where_item, name='' + (
                                    name_prefix or 'data') + f'.find.where[{data__find__where_x}]' + '', definition={'type': 'string'}, rule='type')
                    ...
                    if data__find__exclude_is_list:
                        ...
                        for data__find__exclude_x, data__find__exclude_item in enumerate(data__find__exclude):
                            if not isinstance(data__find__exclude_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.find.exclude[{data__find__exclude_x}]' + ' must be string', value=data__find__exclude_item, name='' + (
                                    name_prefix or 'data') + f'.find.exclude[{data__find__exclude_x}]' + '', definition={'type': 'string'}, rule='type')
                    ...
                    if data__find__include_is_list:
                        ...
                        for data__find__include_x, data__find__include_item in enumerate(data__find__include):
                            if not isinstance(data__find__include_item, (str)):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.find.include[{data__find__include_x}]' + ' must be string', value=data__find__include_item, name='' + (
                                    name_prefix or 'data') + f'.find.include[{data__find__include_x}]' + '', definition={'type': 'string'}, rule='type')
        ...
        for data_key, data_val in data.items():
            if REGEX_PATTERNS['.+'].search(data_key):
                ...
                if not isinstance(data_val, (dict)):
                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.{data_key}' + ' must be object', value=data_val, name='' + (
                        name_prefix or 'data') + f'.{data_key}' + '', definition={'type': 'object'}, rule='type')
    return data
            ...
            if data__keywords_is_list:
                ...
                for data__keywords_x, data__keywords_item in enumerate(data__keywords):
                    if not isinstance(data__keywords_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.keywords[{data__keywords_x}]' + ' must be string', value=data__keywords_item, name='' + (
                            name_prefix or 'data') + f'.keywords[{data__keywords_x}]' + '', definition={'type': 'string'}, rule='type')
            ...
            if data__classifiers_is_list:
                ...
                for data__classifiers_x, data__classifiers_item in enumerate(data__classifiers):
                    if not isinstance(data__classifiers_item, (str)):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.classifiers[{data__classifiers_x}]' + ' must be string', value=data__classifiers_item, name='' + (
                            name_prefix or 'data') + f'.classifiers[{data__classifiers_x}]' + '', definition={'type': 'string', 'format': 'trove-classifier', 'description': '`PyPI classifier <https://pypi.org/classifiers/>`_.'}, rule='type')
                    if isinstance(data__classifiers_item, str):
                        if not custom_formats['trove-classifier'](data__classifiers_item):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.classifiers[{data__classifiers_x}]' + ' must be trove-classifier', value=data__classifiers_item, name='' + (
                                name_prefix or 'data') + f'.classifiers[{data__classifiers_x}]' + '', definition={'type': 'string', 'format': 'trove-classifier', 'description': '`PyPI classifier <https://pypi.org/classifiers/>`_.'}, rule='format')
                ...
                for data__urls_key, data__urls_val in data__urls.items():
                    if REGEX_PATTERNS['^.+$'].search(data__urls_key):
                        ...
                        if not isinstance(data__urls_val, (str)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.urls.{data__urls_key}' + ' must be string', value=data__urls_val, name='' + (
                                name_prefix or 'data') + f'.urls.{data__urls_key}' + '', definition={'type': 'string', 'format': 'url'}, rule='type')
                        if isinstance(data__urls_val, str):
                            if not custom_formats['url'](data__urls_val):
                                raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.urls.{data__urls_key}' + ' must be url', value=data__urls_val, name='' + (
                                    name_prefix or 'data') + f'.urls.{data__urls_key}' + '', definition={'type': 'string', 'format': 'url'}, rule='format')
                if data__urls_keys:
                ...
                for data__optionaldependencies_key, data__optionaldependencies_val in data__optionaldependencies.items():
                    if REGEX_PATTERNS['^.+$'].search(data__optionaldependencies_key):
                        ...
                        if not isinstance(data__optionaldependencies_val, (list, tuple)):
                            raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.optional-dependencies.{data__optionaldependencies_key}' + ' must be array', value=data__optionaldependencies_val, name='' + (name_prefix or 'data') + f'.optional-dependencies.{data__optionaldependencies_key}' + '', definition={
                                                           'type': 'array', 'items': {'$id': '#/definitions/dependency', 'title': 'Dependency', 'type': 'string', 'description': 'Project dependency specification according to PEP 508', 'format': 'pep508'}}, rule='type')
            ...
            if data__dynamic_is_list:
                ...
                for data__dynamic_x, data__dynamic_item in enumerate(data__dynamic):
                    if data__dynamic_item not in ['version', 'description', 'readme', 'requires-python', 'license', 'authors', 'maintainers', 'keywords', 'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies']:
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.dynamic[{data__dynamic_x}]' + " must be one of ['version', 'description', 'readme', 'requires-python', 'license', 'authors', 'maintainers', 'keywords', 'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies']", value=data__dynamic_item, name='' + (
                            name_prefix or 'data') + f'.dynamic[{data__dynamic_x}]' + '', definition={'enum': ['version', 'description', 'readme', 'requires-python', 'license', 'authors', 'maintainers', 'keywords', 'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies']}, rule='enum')
        if data_keys:
            raise JsonSchemaValueException('' + (name_prefix or 'data') + ' must not contain '+str(data_keys)+' properties', value=data, name='' + (name_prefix or 'data') + '', definition={'$schema': 'http://json-schema.org/draft-07/schema', '$id': 'https://packaging.python.org/en/latest/specifications/declaring-project-metadata/', 'title': 'Package metadata stored in the ``project`` table', '$$description': ['Data structure for the **project** table inside ``pyproject.toml``', '(as initially defined in :pep:`621`)'], 'type': 'object', 'properties': {'name': {'type': 'string', 'description': 'The name (primary identifier) of the project. MUST be statically defined.', 'format': 'pep508-identifier'}, 'version': {'type': 'string', 'description': 'The version of the project as supported by :pep:`440`.', 'format': 'pep440'}, 'description': {'type': 'string', '$$description': ['The `summary description of the project', '<https://packaging.python.org/specifications/core-metadata/#summary>`_']}, 'readme': {'$$description': ['`Full/detailed description of the project in the form of a README', '<https://www.python.org/dev/peps/pep-0621/#readme>`_', "with meaning similar to the one defined in `core metadata's Description", '<https://packaging.python.org/specifications/core-metadata/#description>`_'], 'oneOf': [{'type': 'string', '$$description': ['Relative path to a text file (UTF-8) containing the full description', 'of the project. If the file path ends in case-insensitive ``.md`` or', '``.rst`` suffixes, then the content-type is respectively', '``text/markdown`` or ``text/x-rst``']}, {'type': 'object', 'allOf': [{'anyOf': [{'properties': {'file': {'type': 'string', '$$description': ['Relative path to a text file containing the full description', 'of the project.']}}, 'required': ['file']}, {'properties': {'text': {'type': 'string', 'description': 'Full text describing the project.'}}, 'required': ['text']}]}, {'properties': {'content-type': {'type': 'string', '$$description': ['Content-type (:rfc:`1341`) of the full description', '(e.g. ``text/markdown``). The ``charset`` parameter is assumed', 'UTF-8 when not present.'], '$comment': 'TODO: add regex pattern or format?'}}, 'required': ['content-type']}]}]}, 'requires-python': {'type': 'string', 'format': 'pep508-versionspec', '$$description': ['`The Python version requirements of the project', '<https://packaging.python.org/specifications/core-metadata/#requires-python>`_.']}, 'license': {'description': '`Project license <https://www.python.org/dev/peps/pep-0621/#license>`_.', 'oneOf': [{'properties': {'file': {'type': 'string', '$$description': ['Relative path to the file (UTF-8) which contains the license for the', 'project.']}}, 'required': ['file']}, {'properties': {'text': {'type': 'string', '$$description': ['The license of the project whose meaning is that of the', '`License field from the core metadata', '<https://packaging.python.org/specifications/core-metadata/#license>`_.']}}, 'required': ['text']}]}, 'authors': {'type': 'array', 'items': {'$id': '#/definitions/author', 'title': 'Author or Maintainer', '$comment': 'https://www.python.org/dev/peps/pep-0621/#authors-maintainers', 'type': 'object', 'properties': {'name': {'type': 'string', '$$description': ['MUST be a valid email name, i.e. whatever can be put as a name, before an', 'email, in :rfc:`822`.']}, 'email': {'type': 'string', 'format': 'idn-email', 'description': 'MUST be a valid email address'}}}, '$$description': ["The people or organizations considered to be the 'authors' of the project.", 'The exact meaning is open to interpretation (e.g. original or primary authors,', 'current maintainers, or owners of the package).']}, 'maintainers': {'type': 'array', 'items': {'$id': '#/definitions/author', 'title': 'Author or Maintainer', '$comment': 'https://www.python.org/dev/peps/pep-0621/#authors-maintainers', 'type': 'object', 'properties': {'name': {'type': 'string', '$$description': ['MUST be a valid email name, i.e. whatever can be put as a name, before an', 'email, in :rfc:`822`.']}, 'email': {'type': 'string', 'format': 'idn-email', 'description': 'MUST be a valid email address'}}}, '$$description': ["The people or organizations considered to be the 'maintainers' of the project.", 'Similarly to ``authors``, the exact meaning is open to interpretation.']}, 'keywords': {'type': 'array', 'items': {'type': 'string'}, 'description': 'List of keywords to assist searching for the distribution in a larger catalog.'}, 'classifiers': {'type': 'array', 'items': {'type': 'string', 'format': 'trove-classifier', 'description': '`PyPI classifier <https://pypi.org/classifiers/>`_.'}, '$$description': ['`Trove classifiers <https://pypi.org/classifiers/>`_', 'which apply to the project.']}, 'urls': {'type': 'object', 'description': 'URLs associated with the project in the form ``label => value``.', 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'string', 'format': 'url'}}}, 'scripts': {'$id': '#/definitions/entry-point-group', 'title': 'Entry-points', 'type': 'object', '$$description': ['Entry-points are grouped together to indicate what sort of capabilities they', 'provide.', 'See the `packaging guides', '<https://packaging.python.org/specifications/entry-points/>`_', 'and `setuptools docs', '<https://setuptools.pypa.io/en/latest/userguide/entry_point.html>`_', 'for more information.'], 'propertyNames': {'format': 'python-entrypoint-name'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'string', '$$description': [
                                           'Reference to a Python object. It is either in the form', '``importable.module``, or ``importable.module:object.attr``.'], 'format': 'python-entrypoint-reference', '$comment': 'https://packaging.python.org/specifications/entry-points/'}}}, 'gui-scripts': {'$id': '#/definitions/entry-point-group', 'title': 'Entry-points', 'type': 'object', '$$description': ['Entry-points are grouped together to indicate what sort of capabilities they', 'provide.', 'See the `packaging guides', '<https://packaging.python.org/specifications/entry-points/>`_', 'and `setuptools docs', '<https://setuptools.pypa.io/en/latest/userguide/entry_point.html>`_', 'for more information.'], 'propertyNames': {'format': 'python-entrypoint-name'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'string', '$$description': ['Reference to a Python object. It is either in the form', '``importable.module``, or ``importable.module:object.attr``.'], 'format': 'python-entrypoint-reference', '$comment': 'https://packaging.python.org/specifications/entry-points/'}}}, 'entry-points': {'$$description': ['Instruct the installer to expose the given modules/functions via', '``entry-point`` discovery mechanism (useful for plugins).', 'More information available in the `Python packaging guide', '<https://packaging.python.org/specifications/entry-points/>`_.'], 'propertyNames': {'format': 'python-entrypoint-group'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'$id': '#/definitions/entry-point-group', 'title': 'Entry-points', 'type': 'object', '$$description': ['Entry-points are grouped together to indicate what sort of capabilities they', 'provide.', 'See the `packaging guides', '<https://packaging.python.org/specifications/entry-points/>`_', 'and `setuptools docs', '<https://setuptools.pypa.io/en/latest/userguide/entry_point.html>`_', 'for more information.'], 'propertyNames': {'format': 'python-entrypoint-name'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'string', '$$description': ['Reference to a Python object. It is either in the form', '``importable.module``, or ``importable.module:object.attr``.'], 'format': 'python-entrypoint-reference', '$comment': 'https://packaging.python.org/specifications/entry-points/'}}}}}, 'dependencies': {'type': 'array', 'description': 'Project (mandatory) dependencies.', 'items': {'$id': '#/definitions/dependency', 'title': 'Dependency', 'type': 'string', 'description': 'Project dependency specification according to PEP 508', 'format': 'pep508'}}, 'optional-dependencies': {'type': 'object', 'description': 'Optional dependency for the project', 'propertyNames': {'format': 'pep508-identifier'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'array', 'items': {'$id': '#/definitions/dependency', 'title': 'Dependency', 'type': 'string', 'description': 'Project dependency specification according to PEP 508', 'format': 'pep508'}}}}, 'dynamic': {'type': 'array', '$$description': ['Specifies which fields are intentionally unspecified and expected to be', 'dynamically provided by build tools'], 'items': {'enum': ['version', 'description', 'readme', 'requires-python', 'license', 'authors', 'maintainers', 'keywords', 'classifiers', 'urls', 'scripts', 'gui-scripts', 'entry-points', 'dependencies', 'optional-dependencies']}}}, 'required': ['name'], 'additionalProperties': False, 'if': {'not': {'required': ['dynamic'], 'properties': {'dynamic': {'contains': {'const': 'version'}, '$$description': ['version is listed in ``dynamic``']}}}, '$$comment': ['According to :pep:`621`:', '    If the core metadata specification lists a field as "Required", then', '    the metadata MUST specify the field statically or list it in dynamic', 'In turn, `core metadata`_ defines:', '    The required fields are: Metadata-Version, Name, Version.', '    All the other fields are optional.', 'Since ``Metadata-Version`` is defined by the build back-end, ``name`` and', '``version`` are the only mandatory information in ``pyproject.toml``.', '.. _core metadata: https://packaging.python.org/specifications/core-metadata/']}, 'then': {'required': ['version'], '$$description': ['version should be statically defined in the ``version`` field']}, 'definitions': {'author': {'$id': '#/definitions/author', 'title': 'Author or Maintainer', '$comment': 'https://www.python.org/dev/peps/pep-0621/#authors-maintainers', 'type': 'object', 'properties': {'name': {'type': 'string', '$$description': ['MUST be a valid email name, i.e. whatever can be put as a name, before an', 'email, in :rfc:`822`.']}, 'email': {'type': 'string', 'format': 'idn-email', 'description': 'MUST be a valid email address'}}}, 'entry-point-group': {'$id': '#/definitions/entry-point-group', 'title': 'Entry-points', 'type': 'object', '$$description': ['Entry-points are grouped together to indicate what sort of capabilities they', 'provide.', 'See the `packaging guides', '<https://packaging.python.org/specifications/entry-points/>`_', 'and `setuptools docs', '<https://setuptools.pypa.io/en/latest/userguide/entry_point.html>`_', 'for more information.'], 'propertyNames': {'format': 'python-entrypoint-name'}, 'additionalProperties': False, 'patternProperties': {'^.+$': {'type': 'string', '$$description': ['Reference to a Python object. It is either in the form', '``importable.module``, or ``importable.module:object.attr``.'], 'format': 'python-entrypoint-reference', '$comment': 'https://packaging.python.org/specifications/entry-points/'}}}, 'dependency': {'$id': '#/definitions/dependency', 'title': 'Dependency', 'type': 'string', 'description': 'Project dependency specification according to PEP 508', 'format': 'pep508'}}}, rule='additionalProperties')
    try:
        ...
        for data_key, data_val in data.items():
            if REGEX_PATTERNS['^.+$'].search(data_key):
                ...
                if not isinstance(data_val, (str)):
                    raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.{data_key}' + ' must be string', value=data_val, name='' + (name_prefix or 'data') + f'.{data_key}' + '', definition={'type': 'string', '$$description': [
                ...
                if isinstance(data_val, str):
                    if not custom_formats['python-entrypoint-reference'](data_val):
                        raise JsonSchemaValueException('' + (name_prefix or 'data') + f'.{data_key}' + ' must be python-entrypoint-reference', value=data_val, name='' + (name_prefix or 'data') + f'.{data_key}' + '', definition={'type': 'string', '$$description': [
